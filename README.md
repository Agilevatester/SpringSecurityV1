# Spring Security Vulnerability Reachability Evaluation

## Overview

This Java project is intentionally designed to **evaluate reachability of known Spring Security vulnerabilities**, providing a testbed to measure the **efficacy of security tools** such as SAST, DAST, and IAST scanners.

It contains **proof-of-concept (PoC) implementations** of multiple Spring Security-related CVEs across different versions and components of the Spring ecosystem.

> ⚠️ **Disclaimer:** This project is for **research and educational purposes only**. Do **not** use or deploy this in a production environment. Run only in secure, isolated environments.
...
### **Changes Made to Support JDK 8 and Other Versions**
